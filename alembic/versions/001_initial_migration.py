...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_pending_2fa_sessions_id'), 'pending_2fa_sessions', ['id'], unique=False)
    op.create_index('ix_pending_2fa_sessions_temp_token', 'pending_2fa_sessions', ['temp_token'], unique=True)
